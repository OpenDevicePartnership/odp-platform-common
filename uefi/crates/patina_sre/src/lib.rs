...
// in a platform integration crate don't need to depend on the same patina source
// patina_sre uses. Constructing DevicePathBuf via these re-exports guarantees
// type identity with SreBootManager's constructor signature.
